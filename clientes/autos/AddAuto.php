            ...
            <div class="col-lg-12">
                ...
                <form class="form-horizontal" action="CrudAlert.php?&metodo=add&id=<?php echo $id ?>" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control input-sm" id="placa" name="placa" autofocus>
                        </div>
                    </div>
                    <!-- Marca del auto-->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control input-sm" name="anio">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control input-sm" name="transmision">
