...
$orden = orden::getOrdenId($num_orden)[orden::NOMBRE_TABLA][0];
print_r($orden);
...
$servicios = servicio::getServiciosOrden($num_orden)[servicio::NOMBRE_TABLA];

$productos = producto::getProductosOrden($num_orden)[producto::NOMBRE_TABLA];
...
<?php include "main_in.php" ?>

<script src="../citas/js/jquery-3.2.0.min.js"></script>
<script src="../citas/js/bootstrap.js"></script>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="../ordns_servicios/recepccionAuto.php" method="POST"
                        ...
                        <div class="table-responsive">
                            ...
                            $echo2 = '<h4 class="info"><td>Mano de Obra:  ' . $orden['mano_obra'] . '</td></h4><br>';

                            $echo3 = $tservicios . '<br><br>' . $tproductos;
                            $echo4 = '<h3 align="right" class="info">Total:  ' . ($orden['mano_obra'] + $stproductos + $stservicios) . '</h3>';
