    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="vista/citas/Calendario.php">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="vista/citas/Calendario.php">
                            <span class="glyphicon glyphicon-list-alt"></span> Citas
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="vista/personas/AddPersona.php">
                                    Cliente
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="dopdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="vista/personas/AddPersona.php?tipo=CLIENTE">
                                    <span class="glyphicon glyphicon-plus"></span> Nuevo Cliente
                                </a>
                            </li>
                            <li>
                                <a href="vista/personas/QueryPersona.php?tipo=CLIENTE">
                    ...
                    <li class="dopdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="vista/personas/AddPersona.php?tipo=MECANICO">
                                    <span class="glyphicon glyphicon-plus"></span> Nuevo Mecanico
                                </a>
                            </li>
                            <li>
                                <a href="vista/personas/QueryPersona.php?tipo=MECANICO">
                    ...
                    <li class="dopdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="vista/autos/AddAuto.php">
                                    <span class="glyphicon glyphicon-plus"></span> Nuevo Auto
                                </a>
                            </li>
                            <li>
                                <a href="vista/autos/QueryAutos.php">
                    ...
                    <li class="dopdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="vista/empresas/QueryEmpresa.php">
                                    <span class="glyphicon glyphicon-credit-card"></span> Proveedores
                                </a>
                            </li>

                            <li>
                                <a href="vista/inventario/QueryProductos.php">
