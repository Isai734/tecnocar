...
require '../vista/VistaXML.php';
require '../utilidades/ExcepcionApi.php';
require '../control/persona.php';
require '../control/GPeople.php';
require '../control/auto.php';
require '../control/orden.php';
require '../control/servicio.php';
require '../control/cita.php';
...
$recursos_existentes = array('persona', 'login', 'auto','orden','servicio','cita');
