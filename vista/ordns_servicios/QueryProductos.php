        ...
        <table class="order-table table table-striped" id="tabla">
            ...
            foreach ($datos as $res) {
                ...
                echo '		<td><a href="UpdateProductos.php?id=' . $res[producto::CLAVE] . '&clave=' . $res[producto::PROVEEDOR_CLAVE] . '" data-toggle="tooltip" data-placement="top" title="Modificar"><button class="btn btn-warning"> <span class="glyphicon glyphicon-pencil"></span></button></a></td>
			        		<td><a href="CrudAlert.php?id=' . $res[producto::CLAVE] . '&metodo=delete' . '" data-toggle="tooltip" data-placement="top" title="Eliminar"><button class="btn btn-danger"> <span class="glyphicon glyphicon-remove"></span></button></a></td>
			        		<td><a href="CrudAlert.php?id=' . $res[producto::CLAVE] . '" data-toggle="tooltip" data-placement="top" title="Nuevo Auto"><button class="btn btn-success"> <span class="glyphicon glyphicon-bed"></span></button></a></td>
			    		</tr>';
            }
            ?>
            </tbody>
