...
<div id="page-wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <!-- FORMULARIO -->
                <form class="form-horizontal" action="CrudAlert.php?tipo=&metodo=add" method="POST"
                    ...
                    <br>
                    <!--Mano de Obra numero_orden, mano_obra, subtotal, total, mecanico_clave, auto_placa, estatus-->
                    <div class="form-group">
                        <label class="control-label col-sm-2">Mano de obra:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="placa" name="mano_obra" autofocus>
                        </div>
                    </div>
                    <br>
                    <!--Select Servicios-->
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select onchange="addRowTblServicios()" class="form-control" name="auto_placa" id="tipo_servicio">
...
<script>
    ...
    function addRow() {
        ...
        sub.setAttribute("name", "cantidad[]");
        sub.setAttribute("id", "cantidad[]");
    ...
    function addRowTblServicios() {
        ...
        try {
            for (var i = 0; i < autos.length; i++) {
                ...
                cantidad.setAttribute("id", "check[]");
                div.appendChild(cantidad);
                var celda1 = document.createElement("td");
                celda1.appendChild(div);
                hilera.appendChild(celda1);
